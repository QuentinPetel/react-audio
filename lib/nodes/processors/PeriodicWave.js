...
var PeriodicWave = function (_AudioNode) {
	_inherits(PeriodicWave, _AudioNode);

	function PeriodicWave() {
		_classCallCheck(this, PeriodicWave);

		var _this = _possibleConstructorReturn(this, (PeriodicWave.__proto__ || Object.getPrototypeOf(PeriodicWave)).call(this));
